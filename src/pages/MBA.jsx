    ...
    <div className="min-h-screen bg-white">
      <section className="py-16">
        <div className="max-w-7xl mx-auto px-4">
          <motion.h1 initial={{opacity:0,y:12}} animate={{opacity:1,y:0}} transition={{duration:0.45}} className="text-4xl md:text-5xl font-extrabold text-slate-900">MBA (Master)</motion.h1>
          <motion.p initial={{opacity:0,y:12}} animate={{opacity:1,y:0}} transition={{duration:0.55, delay:0.05}} className="mt-3 text-slate-600 max-w-3xl">
            Industry-aligned programs designed to build leadership, strategy, and data-driven decision-making for high-impact roles.
          </motion.p>

          <div className="mt-10 grid md:grid-cols-3 gap-6">
            {[
              {title:'Core Tracks', desc:'Strategy, Finance, Marketing, Analytics, Operations, and Leadership.'},
              {title:'Experiential', desc:'Capstones, live projects, and simulations with industry partners.'},
              {title:'Career Outcomes', desc:'Management consulting, product, operations, and strategic roles.'},
            ].map((b, i) => (
