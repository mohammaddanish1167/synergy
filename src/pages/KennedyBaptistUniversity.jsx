...
const KennedyBaptistUniversity = () => {
  ...
  const university = {
    ...
    verified: true,
    description: 'Kennedy Baptist University combines academic rigor with moral and ethical leadership training. We are dedicated to nurturing well-rounded individuals who make a positive impact on society.',
    features: [
      'Ethical Leadership',
