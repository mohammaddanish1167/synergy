    ...
    <div className="min-h-screen bg-white">
      <section className="py-16">
        <div className="max-w-7xl mx-auto px-4">
          <motion.h1 initial={{opacity:0,y:12}} animate={{opacity:1,y:0}} transition={{duration:0.45}} className="text-4xl md:text-5xl font-extrabold text-slate-900">Honorary Professorship</motion.h1>
          <motion.p initial={{opacity:0,y:12}} animate={{opacity:1,y:0}} transition={{duration:0.55, delay:0.05}} className="mt-3 text-slate-600 max-w-3xl">
            Recognition for exemplary academic, industry, or societal contributions through collaborative teaching and research engagements.
          </motion.p>

          <div className="mt-10 grid md:grid-cols-3 gap-6">
            {[
              {title:'Contributions', desc:'Teaching masterclasses, mentoring, and advisory roles across departments.'},
              {title:'Evaluation', desc:'Track record of excellence, peer recognition, and measurable outcomes.'},
              {title:'Engagement', desc:'Joint research, publications, curriculum co-design, and community impact.'},
            ].map((b, i) => (
