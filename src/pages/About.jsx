...
function About() {
  ...
  return (
    <div ref={containerRef} className="relative min-h-screen bg-gradient-to-b from-gray-950 via-gray-900 to-black overflow-hidden">
      ...
      {/* Leadership Team */}
      <section id="leadership" className="animate-section py-20 px-4">
        <div className="max-w-6xl mx-auto">
          <motion.div
            initial={{ opacity: 0, y: 30 }}
            whileInView={{ opacity: 1, y: 0 }}
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {leadership.map((leader, idx) => (
              ...
              >
                {/* Glow effect */}
                <div className={`absolute -inset-4 bg-gradient-to-br ${leader.color} rounded-3xl blur-xl opacity-0 group-hover:opacity-20 transition-opacity duration-300`} />
                
                <div className="relative bg-gray-900/50 backdrop-blur-sm rounded-2xl border border-white/10 p-8 overflow-hidden">
                  ...
                  <div className="relative z-10">
                    <div className="flex items-center gap-6 mb-6">
                      <motion.div
                        className={`w-20 h-20 rounded-2xl bg-gradient-to-br ${leader.color} flex items-center justify-center shadow-2xl`}
                      ...
                      <div>
                        ...
                        <div className="text-blue-400 font-medium">{leader.role}</div>
                      </div>
                    </div>
                  ...
                  {/* Connection lines */}
                  <svg className="absolute bottom-4 right-4 w-16 h-16 opacity-20">
                    <motion.path
                      d="M0,0 Q20,20 40,0 Q60,-20 80,0"
                      stroke="white"
                      strokeWidth="2"
                      fill="none"
                      strokeDasharray="5,5"
