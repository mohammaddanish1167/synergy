    ...
    <div className="min-h-screen bg-white">
      <section className="py-16">
        <div className="max-w-7xl mx-auto px-4">
          <motion.h1 initial={{opacity:0,y:12}} animate={{opacity:1,y:0}} transition={{duration:0.45}} className="text-4xl md:text-5xl font-extrabold text-slate-900">DBA</motion.h1>
          <motion.p initial={{opacity:0,y:12}} animate={{opacity:1,y:0}} transition={{duration:0.55, delay:0.05}} className="mt-3 text-slate-600 max-w-3xl">
            Executive doctoral program focused on applied research, strategic insight, and organizational transformation.
          </motion.p>

          <div className="mt-10 grid md:grid-cols-3 gap-6">
            {[
              {title:'Focus', desc:'Translating complex business challenges into rigorous research questions.'},
              {title:'Method', desc:'Mixed methods, field studies, design science, and evidence-based management.'},
              {title:'Impact', desc:'Publications, whitepapers, and measurable outcomes for the enterprise.'},
            ].map((b, i) => (
